...
#     """Get all guests"""
#     db = get_database()  # NOT await - it's a regular function
...
#             if "_id" in guest_doc:
#                 guest_doc["_id"] = str(guest_doc["_id"])
...
#     if created_guest and "_id" in created_guest:
#         created_guest["_id"] = str(created_guest["_id"])
...
#     # Convert _id to string
#     if updated_guest and "_id" in updated_guest:
